...
void CPaodian::CreateSubControl()
{
...
void CPaodian::Update(int x, int y, BYTE LB, BYTE MB, BYTE RB, int nScroll, float fElapsedTime, BOOL bFirstControl)
{
...
void CPaodian::TranslateUIMessage(UIGUID ControlID, DWORD dwMsg)
{
...
void CPaodian::ResetAll(bool bEdit)
{
...
CBasicButton* CPaodian::CreateFlipButton(char* szButton, char* szButtonFlip, UIGUID ControlID)
{
