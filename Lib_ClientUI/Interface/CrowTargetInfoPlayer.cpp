...
{	 
	...
	if ( wSchool != pCHAR->GetSchool() ){
		...
		strSchoolCombine.Format ("學院:%s", ID2GAMEWORD("ACADEMY_NAME",fSchool));
	...
	}
	{
		...
		m_pTextBox->SetOneLineText ( "快捷鍵:左Shift+左鍵", NS_UITEXTCOLOR::GOLD );
