...

		{
			...
			case ITEM_ANTI_DISAPPEAR:
			{
				...
				if (sItemCustom.nidDISGUISE != NATIVEID_NULL())
				{
					...
					if (dwReqCharClass)
					{
						if ((dwReqCharClass == GLCC_ALL_8CLASS) && (dwReqCharClass_Disguise == GLCC_ALL_8CLASS) || (dwReqCharClass == GLCC_ALL_7CLASS) && (dwReqCharClass_Disguise == GLCC_ALL_7CLASS)
							|| (dwReqCharClass == GLCC_ALL_6CLASS) && (dwReqCharClass_Disguise == GLCC_ALL_6CLASS))
						{
							szClass = ID2GAMEWORD("ITEM_ALL_CLASS");
						}
						else if ((dwReqCharClass == GLCC_MAN_8CLASS) && (dwReqCharClass_Disguise == GLCC_MAN_8CLASS) || (dwReqCharClass == GLCC_MAN_7CLASS) && (dwReqCharClass_Disguise == GLCC_MAN_7CLASS)
							|| (dwReqCharClass == GLCC_MAN_6CLASS) && (dwReqCharClass_Disguise == GLCC_MAN_6CLASS))
						{
							szClass = ID2GAMEWORD("ITEM_ALL_MALE_CLASS");
						}
						else if ((dwReqCharClass == GLCC_WOMAN_8CLASS) && (dwReqCharClass_Disguise == GLCC_WOMAN_8CLASS) || (dwReqCharClass == GLCC_WOMAN_7CLASS) && (dwReqCharClass_Disguise == GLCC_WOMAN_7CLASS)
							|| (dwReqCharClass == GLCC_WOMAN_6CLASS) && (dwReqCharClass_Disguise == GLCC_WOMAN_6CLASS))
						{
				...
				else
				{
					...
					if (dwReqCharClass)
					{
						if ((dwReqCharClass == GLCC_ALL_8CLASS) || (dwReqCharClass == GLCC_ALL_7CLASS) || (dwReqCharClass == GLCC_ALL_6CLASS))
						{
							szClass = ID2GAMEWORD("ITEM_ALL_CLASS");
						}
						else if ((dwReqCharClass == GLCC_MAN_8CLASS) || (dwReqCharClass == GLCC_MAN_7CLASS) || (dwReqCharClass == GLCC_MAN_6CLASS))
						{
							szClass = ID2GAMEWORD("ITEM_ALL_MALE_CLASS");
						}
						else if ((dwReqCharClass == GLCC_WOMAN_8CLASS) || (dwReqCharClass == GLCC_WOMAN_7CLASS) || (dwReqCharClass == GLCC_WOMAN_6CLASS))
						{
							szClass = ID2GAMEWORD("ITEM_ALL_FEMALE_CLASS");
						}
						else
				...
				if (sItemCustom.IsSetRandOpt())
				{
					...
					if ((nRandOptType1 && nRandOptType1 == EMR_OPT_DAMAGE))
					{
						...
						if (fVal != 0.0f)
						{
							...
							AddTextNoSplit(strDescText, NS_UITEXTCOLOR::AQUAMARINE);
						}
					}
