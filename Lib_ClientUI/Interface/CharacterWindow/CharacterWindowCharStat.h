...
protected:
	enum
	{
		...
		CHARACTER_RESET_SKST_TO,
		CHARACTER_RESET_SKST_TO1,
		CHARACTER_RESET_SKST_TO2,
		CHARACTER_RESET_SKST_TO3,
		CHARACTER_RESET_SKST_TO4,
		CHARACTER_RESET_SKST_TO5,
		CHARACTER_RESET_SKST_TO6,
		CHARACTER_RESET_SKST_TO7,
...
private:
	...
	CBasicTextButton* CreateTextButton19(const char* szButton, UIGUID ControlID, const char* szText);
private:
