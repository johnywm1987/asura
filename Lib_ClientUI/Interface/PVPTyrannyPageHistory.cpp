...
void CPVPTyrannyPageHistory::CreateSubControl()
{
	...
	m_pTextHistoryTitleStatic->AddText(ID2GAMEWORD("COMPETITION_CTF_HISTORY", 0), NS_UITEXTCOLOR::ORANGE);
	m_pTextHistoryTimeStatic->AddText(ID2GAMEWORD("COMPETITION_CTF_HISTORY", 1), NS_UITEXTCOLOR::ORANGE);
	m_pTextHistoryAuthStatic->AddText(ID2GAMEWORD("COMPETITION_CTF_HISTORY", 2), NS_UITEXTCOLOR::WHITE);
	m_pTextHistoryRewardStatic->AddText(ID2GAMEWORD("COMPETITION_CTF_HISTORY", 3), NS_UITEXTCOLOR::ORANGE);
	...
	m_pButtonRanking = new CBasicTextButton;
	m_pButtonRanking->CreateSub(this, "BASIC_TEXT_BUTTON16", UI_FLAG_DEFAULT, TYRANNY_PAGE_INFO_HISTORY_BUTTON_RANKING);
	m_pButtonRanking->CreateBaseButton("COMPETITION_CTF_PAGE_HISTORY_RANKING_BUTTON", CBasicTextButton::SIZE16, CBasicButton::CLICK_FLIP, ID2GAMEWORD("COMPETITION_CTF_BATTLE_TEXT", 12));
