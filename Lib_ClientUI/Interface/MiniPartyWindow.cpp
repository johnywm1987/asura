...
{	
	...
	CString strMemberKeyword[MAXPARTY] = 
	{
		...
		"MINIPARTY_SLOT_MEMBER8",
		"MINIPARTY_SLOT_MEMBER9",
		"MINIPARTY_SLOT_MEMBER10",
		"MINIPARTY_SLOT_MEMBER11",
		"MINIPARTY_SLOT_MEMBER12",
		"MINIPARTY_SLOT_MEMBER13",
		"MINIPARTY_SLOT_MEMBER14",
	};
	...
	CString strMemberOverKeyword[MAXPARTY] =
	{
		...
		"MINIPARTY_SLOT_OVER8",
		"MINIPARTY_SLOT_OVER9",
		"MINIPARTY_SLOT_OVER10",
		"MINIPARTY_SLOT_OVER11",
		"MINIPARTY_SLOT_OVER12",
		"MINIPARTY_SLOT_OVER13",
		"MINIPARTY_SLOT_OVER14",
	};
...
void CMiniPartyWindow::TranslateUIMessage ( UIGUID ControlID, DWORD dwMsg )
{
	...
	case MINIPARTY_SLOT_MEMBER8:
	case MINIPARTY_SLOT_MEMBER9:
	case MINIPARTY_SLOT_MEMBER10:
	case MINIPARTY_SLOT_MEMBER11:
	case MINIPARTY_SLOT_MEMBER12:
	case MINIPARTY_SLOT_MEMBER13:
	case MINIPARTY_SLOT_MEMBER14:
		{
			if ( CHECK_MOUSE_IN ( dwMsg ) )
			{
				m_bMOUSEIN = true;
