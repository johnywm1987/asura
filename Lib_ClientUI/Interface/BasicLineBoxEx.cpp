...
void CBasicLineBoxEx::CreateBaseBoxVarTextBoxBubu(char* szBoxControl)
{
	CreateBodyImage("BASIC_LINE_BOX_EX_BODY_VARTEXTBUBU");
	CreateLineImage("BASIC_LINE_BOX_EX_LEFT_VARTEXTBUBU", "BASIC_LINE_BOX_EX_RIGHT_VARTEXTBUBU", "BASIC_LINE_BOX_EX_TOP_VARTEXTBUBU", "BASIC_LINE_BOX_EX_BOTTOM_VARTEXTBUBU");
	CreateLineImageEx("BASIC_LINE_BOX_EX_LEFTTOP_VARTEXTBUBU", "BASIC_LINE_BOX_EX_LEFTBOTTOM_VARTEXTBUBU", "BASIC_LINE_BOX_EX_RIGHTTOP_VARTEXTBUBU", "BASIC_LINE_BOX_EX_RIGHTBOTTOM_VARTEXTBUBU");
	ResizeControl(szBoxControl);
}
