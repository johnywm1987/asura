...
void CPVPTyrannyPage::CreateSubControl()
{
	...
	CreateUILineBoxQuestList("COMPETITION_CTF_PAGE_INFO_LINEBOX_TARGET");
	CreateUILineBoxQuestList("COMPETITION_CTF_PAGE_INFO_LINEBOX_BOTTOM");
	CreateUILineBoxQuestList("COMPETITION_CTF_PAGE_INFO_LINEBOX_DETAIL");
	CreateUILineBoxQuestList("COMPETITION_CTF_PAGE_INFO_LINEBOX_REWARD");
	CreateUILineBoxQuestList("COMPETITION_CTF_PAGE_INFO_LINEBOX_INSTANT");
	CreateUILineBoxQuestList("COMPETITION_CTF_PAGE_INFO_LINEBOX_TARGET2");
	CreateUILineBoxQuestList("COMPETITION_CTF_PAGE_INFO_LINEBOX_DETAIL2");
	CreateUILineBoxQuestList("COMPETITION_CTF_PAGE_INFO_LINEBOX_REWARD2");
	...
	CreateUILineBoxWhiteNoBody("COMPETITION_CTF_PAGE_INFO_LINEBOX_TARGET");
	CreateUILineBoxWhiteNoBody("COMPETITION_CTF_PAGE_INFO_LINEBOX_BOTTOM");
	CreateUILineBoxWhiteNoBody("COMPETITION_CTF_PAGE_INFO_LINEBOX_DETAIL");
	CreateUILineBoxWhiteNoBody("COMPETITION_CTF_PAGE_INFO_LINEBOX_REWARD");
	CreateUILineBoxWhiteNoBody("COMPETITION_CTF_PAGE_INFO_LINEBOX_INSTANT");
	CreateUILineBoxWhiteNoBody("COMPETITION_CTF_PAGE_INFO_LINEBOX_TARGET2");
	CreateUILineBoxWhiteNoBody("COMPETITION_CTF_PAGE_INFO_LINEBOX_DETAIL2");
	CreateUILineBoxWhiteNoBody("COMPETITION_CTF_PAGE_INFO_LINEBOX_REWARD2");
	...
	m_pSelect = new CTipBox;
	m_pSelect->CreateSub(this, "QUEST_WINDOW_CHILD_BOX", UI_FLAG_XSIZE | UI_FLAG_YSIZE);
	m_pSelect->CreateQuestSelect("RNCOMPETITION_TYPE_SUB2");
	RegisterControl(m_pSelect);
	m_pSelect->SetVisibleSingle(TRUE);
}
...
void CPVPTyrannyPage::UpdateInfo()
{
	...
	if (m_pTextReward)
	{
		...
		//reward loss
		nIndex = m_pTextReward->AddText(ID2GAMEWORD("COMPETITION_CTF_BATTLE_AWARD_TEXT", 2), NS_UITEXTCOLOR::GREENYELLOW);
		m_pTextReward->AddString(nIndex, ID2GAMEWORD("COMPETITION_CTF_BATTLE_AWARD_TYPE", 1), NS_UITEXTCOLOR::GREENYELLOW);
	}
}