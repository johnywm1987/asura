...
//쭌Ν쮝꽝
class CSetChaRellChange : public CDbAction
{
public:
	CSetChaRellChange(DWORD dwChaNum, int nReborn, int m_nLevel, int m_nStatsPoint, int m_nSkillPoint, int m_nlnMoney);
	virtual ~CSetChaRellChange()
	{
...
{
public:
	CUpdateMoneyPoints(DWORD dwPremium, DWORD dwCombat,CString strUserID);
...
{
public:
	CDeductMoneyPoints( DWORD dwPremium, DWORD dwCombat, CString strUserID );
