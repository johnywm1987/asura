...
*/
		...
		else if (strCOMMAND == "/skill")
		{

			if (strArray.GetSize() != 2)
			{
				CInnerInterface::GetInstance().PrintConsoleText("invalid param");
				return true;
			}
			if (strArray.GetSize() == 2)
			{
				...
				DWORD	dwpass = (WORD)atoi(strPARAM_02.GetString());
				GLGaeaClient::GetInstance().GetCharacter()->ReqGMSkillAll(wLevel, dwpass);
			}
