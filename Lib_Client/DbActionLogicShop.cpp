...
CUpdateMoneyPoints::CUpdateMoneyPoints( 
	DWORD dwPremium, DWORD dwCombat,
	CString strUserID )
{
	m_dwPremium = dwPremium;
	m_dwCombatPoint = dwCombat;
	m_strUserID = strUserID;
}

int CUpdateMoneyPoints::Execute( CServer* pServer )
{
	return m_pDbManager->UpdateMoneyPoint ( m_dwPremium, m_dwCombatPoint, m_strUserID );
}
...
{
	return m_pDbManager->DeductMoneyPoint ( m_dwPremium, m_dwCombatPoint, m_strUserID );
}