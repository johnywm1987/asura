...
//쭌Ν쮝꽝
CSetChaRellChange::CSetChaRellChange(DWORD dwChaNum, int nReborn, int nLevel, int nStatsPoint, int nSkillPoint, int nlnMoney)
{
	m_dwChaNum = dwChaNum;
	m_nReborn = nReborn;
	m_nLevel = nLevel;
	m_nStatsPoint = nStatsPoint;
	m_nSkillPoint = nSkillPoint;
...
int CSetChaRellChange::Execute(CServer* pServer)
{
	return m_pDbManager->SetChaRellChange(m_dwChaNum, m_nReborn, m_nLevel, m_nStatsPoint, m_nSkillPoint, m_nlnMoney);
}
