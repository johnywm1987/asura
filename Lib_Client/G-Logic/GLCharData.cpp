...
const SITEMCUSTOM& SCHARDATA2::GET_ZBSJ_ITEM()	// ITEMREBUILD_MARK
{
	static SITEMCUSTOM sItemCustom;
	sItemCustom.sNativeID = NATIVEID_NULL();
	...
	SINVENITEM* pResistItem = m_cInventory.GetItem(m_sZbsjItem.wPosX, m_sZbsjItem.wPosY);
	if (!pResistItem)
		return sItemCustom;
