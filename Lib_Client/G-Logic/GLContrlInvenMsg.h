...
{
	EMREQ_REGISTER_CODEX_FB_FAIL		= 0,	//	ÀÏ¹Ý¿À·ù.
	EMREQ_REGISTER_CODEX_FB_OK			= 1,	//	¼º°ø.
	EMREQ_REGISTER_CODEX_FB_NOITEM		= 2,	//	»óÀÚ ¾ÆÀÌÅÛÀÌ ¾øÀ½.
	EMREQ_REGISTER_CODEX_FB_NOBOX		= 3,	//	»óÀÚ°¡ ¾Æ´Ô.
	EMREQ_REGISTER_CODEX_FB_EMPTY		= 4,	//	»óÀÚ ¾È¿¡ ³»¿ë¹°ÀÌ ¾ø½À´Ï´Ù.
	EMREQ_REGISTER_CODEX_FB_NOTINVEN	= 5,	//	ÀÎº¥ °ø°£ÀÌ ºÎÁ·.
	EMREQ_REGISTER_CODEX_FB_INVALIDITEM= 6,	//	Àß¸øµÈ ¾ÆÀÌÅÛÀÌ µé¾î ÀÖÀ½.
};
...
{
	EMREQ_ZBSJOPEN_FB_FAIL = 0,	//	°³Á¶Ä«µå »ç¿ë¿¡ ½ÇÆÐ.
	EMREQ_ZBSJOPEN_FB_OK = 1,	//	°³Á¶Ä«µå »ç¿ë¿¡ ¼º°ø.
	EMREQ_ZBSJOPEN_FB_NOITEM = 2,	//	°³Á¶Ä«µå ¾ÆÀÌÅÛÀÌ ¾øÀ½.
};
...
{
	EMREQ_ITEMSHOP_FROMDB_FB_END		= 0,	//	¸¶Áö¸·¾ÆÀÌÅÛ
	EMREQ_ITEMSHOP_FROMDB_FB_OK		= 1,	//	¼º°ø
};
...
{
	EMREQ_RESET_SKST_TO_FB_FAIL = 0,	//	ÃÊ±âÈ­ ½ÇÆÐ.
	EMREQ_RESET_SKST_TO_FB_OK = 1,	//	ÃÊ±âÈ­ ¼º°ø.
...
{
	EMREQ_RESET_SKST_TO_FB1_FAIL = 0,	//	ÃÊ±âÈ­ ½ÇÆÐ.
	EMREQ_RESET_SKST_TO_FB1_OK = 1,	//	ÃÊ±âÈ­ ¼º°ø.
...
{
	EMREQ_UPGRADE_CARD_FB_FAIL = 0,	//	ÀÎº¥ Ä«µå »ç¿ë¿¡ ½ÇÆÐ.
	EMREQ_UPGRADE_CARD_FB_OK = 1,	//	ÀÎº¥ Ä«µå »ç¿ë¿¡ ¼º°ø.
	EMREQ_UPGRADE_CARD_FB_NOITEM = 2,	//	ÀÎº¥ Ä«µå ¾ÆÀÌÅÛÀÌ ¾øÀ½.
	EMREQ_UPGRADE_CARD_FB_MAX = 3,	//	´õ ÀÌ»ó Ãß°¡ °¡´ÉÇÑ ÀÎº¥È®»ó ºÒ°¡´É.
};
//¸Ë³Æ¤É¯Å
enum EMREBUILD_ZBSJ	// ITEMREBUILD_MARK
{
	EMREBUILD_ZBSJ_FAIL		= 0,	// ÀÏ¹Ý ¿À·ù
	EMREBUILD_ZBSJ_OPEN		= 1,	// °³Á¶ ÀÎÅÍÆäÀÌ½º ¿­±â
	EMREBUILD_ZBSJ_SUCCESS	= 2,	// È®ÀÎ ¹öÆ° ´­·¶°í, °³Á¶ ¼º°ø
	EMREBUILD_ZBSJ_DESTROY	= 3,	// È®ÀÎ ¹öÆ° ´­·¶°í, °³Á¶ ½ÇÆÐ, ¾ÆÀÌÅÛ ¼Ò¸ê
	EMREBUILD_ZBSJ_MONEY		= 4,	// È®ÀÎ ¹öÆ° ´­·¶°í, ±Ý¾×ÀÌ ¸ÂÁö ¾Ê¾Æ¼­ ¿À·ù Àü¼Û
	EMREBUILD_ZBSJ_CLOSE		= 5,		// °³Á¶ ÀÎÅÍÆäÀÌ½º ´Ý±â
	EMREBUILD_ZBSJ_DAMAGE	= 6, //¬ã¿i§ðÀ»¤O
	EMREBUILD_ZBSJ_DEFENSE	= 7, //¬ã¿i¨¾¿m¤O
	EMREBUILD_ZBSJ_TYPE1	= 8, //ÀH¾÷²Ä¤@¦æ
	EMREBUILD_ZBSJ_TYPE2	= 9, //ÀH¾÷²Ä¤G¦æ
	EMREBUILD_ZBSJ_TYPE3	= 10, //ÀH¾÷²Ä¤T¦æ
	EMREBUILD_ZBSJ_TYPE4	= 11, //ÀH¾÷²Ä¥|¦æ
	EMREBUILD_ZBSJ_MAX		= 12,//³Ì¤j­È
	EMREBUILD_ZBSJ_NO		= 13,//ªÅ­È
	EMREBUILD_ZBSJ_BO		= 14,//¶}Ãö
	EMREBUILD_ZBSJ_REBA		= 15,//ÄÝ©Ê¥¼¶}©ñ
	EMREBUILD_ZBSJ_ITEM		= 16,//ª««~¸T¤î
	EMREBUILD_ZBSJ_ITEMRATE		= 17,//ª««~¤É¯Å¾÷²v
};
