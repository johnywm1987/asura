...
bool GLITEMLMT::DoCheckItemGen ( const SNATIVEID &sNID, EMITEMGEN emTYPE /*=EMGEN_DEFAULT*/ )
{
	...
	//	ÀÌº¥Æ® ¾ÆÀÌÅÛÀÌ ¾Æ´Ò °æ¿ì »ý¼º ¹«Á¶°Ç °¡´É.
...
{
	/*
	//	Note : Ä³¸¯ÅÍ »ý¼º½Ã ºÎ¿©µÇ´Â ¾ÆÀÌÅÛÀº item ROUTE Á¤º¸ ÀúÀåÇÏÁö ¾ÊÀ½.
	...
	{
		//	Note : ¾ÆÀÌÅÛ ¼³Á¤ÀÌ °ãÄ§°¡´ÉÀÏ °æ¿ì Item ROUTE Á¤º¸ ÀúÀåÇÏÁö ¾ÊÀ½.
