...
enum EM_ITEMZBSJ_MIX
{
	ITEMZBSJMIX_ITEMOPTNUM = 1,
};

struct ITEMZBSJMIX_DATA
{
	BOOL    bLock;//開關
	EMRANDOM_OPT emOPT;
	DWORD	m_fOptValue;
	...
	void RESET() { bLock = FALSE; emOPT = EMR_OPT_NULL; m_fOptValue = 0; m_dwOptMax = 0; m_fOptPoint = 0; m_dwRate = 0; }
};
