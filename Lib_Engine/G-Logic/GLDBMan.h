...
public:
	...
	*/
	...
	//쭌Ν쮝꽝
	virtual int SetChaRellChange(DWORD dwChaNum, int nReborn, int nLevel, int nStatsPoint, int nSkillPoint, int nlnMoney) { return 0; }
	...
	*/
	...
	virtual int UpdateMoneyPoint(DWORD dwPremium, DWORD dwCombat,CString strUserID )	{return 0;}

	//PANDORA - Added by Arwekaj09 to Deduct UserPoint or E-Points
	virtual int DeductMoneyPoint(DWORD dwPremium, DWORD dwCombat, CString strUserID )	{return 0;}
