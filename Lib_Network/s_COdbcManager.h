...
public:
	...
	*/
	...
	int SetChaRebornChange(DWORD dwChaNum, int nReborn, int nLevel, int nStatsPoint, int nSkillPoint, int nlnMoney, int nlnVoteP, int nlnPremP);
	...
	*/
	...
	int UpdateMoneyPoint( DWORD dwPremium, DWORD dwCombat, CString strUserID );

	//PANDORA - Added by Arwekaj09 to Deduct UserPoint or E-Points
	int DeductMoneyPoint( DWORD dwPremium, DWORD dwCombat, CString strUserID );
