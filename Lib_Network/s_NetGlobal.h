...
#define MAX_WORKER_THREAD		    6       ///< ¼ýÀÚ°¡ 4°³ÀÌÇÏÀÏ¶§ µô·¹ÀÌ¹ß»ý
                                            ///< ÀÇµµÀûÀ¸·Î 6 °³·Î Çß´Ù.
...
//	NET_MSG_APEX_RSAKEY				= (NET_MSG_GCTRL +	32), //< Apex RSA Key ¸Þ¼¼Áö
	...
	NET_MSG_GCTRL_REQ_STATSUPCMD	= (NET_MSG_GCTRL + 387),	//<	STATS UP CMD ÀÀ´ä.
	NET_MSG_GCTRL_REQ_STATSUPCMD_FB	= (NET_MSG_GCTRL + 388),	//<	STATS UP CMD ÀÀ´ä.
	...
	NET_MSG_GM_CAMERA_ONOFF				= (NET_MSG_GCTRL + 719),	//<	°³ÀÎ »óÁ¡ ¿ÀÇÂ.
	...
	NET_MSG_GM_EVENT_MONEY_GEN_END		= (NET_MSG_GCTRL + 911),	//<	µ· ¹ß»ýÀ² ÀÌº¥Æ® Á¾·á.
...
//-----------------------------------------------------------------------------------------------------------
	...
	NET_MSG_PET_REQ_SKILLCHANGE_A		= (NET_MSG_GCTRL + 1143),	// ½ºÅ³º¯°æ
	NET_MSG_PET_REQ_SKILLCHANGE_A_FB	= (NET_MSG_GCTRL + 1144),	// ½ºÅ³º¯°æ
	NET_MSG_PET_REQ_SKILLCHANGE_A_BRD	= (NET_MSG_GCTRL + 1145),	// ½ºÅ³º¯°æ
	NET_MSG_PET_ADD_SKILLFACT_A			= (NET_MSG_GCTRL + 1146),	// SkillFact Ãß°¡
	NET_MSG_PET_REMOVE_SKILLFACT_A		= (NET_MSG_GCTRL + 1147),	// SkillFact Ãß°¡

	/*dual pet skill, Juver, 2017/12/27 */
	NET_MSG_PET_REQ_SKILLCHANGE_B		= (NET_MSG_GCTRL + 1148),	// ½ºÅ³º¯°æ
	NET_MSG_PET_REQ_SKILLCHANGE_B_FB	= (NET_MSG_GCTRL + 1149),	// ½ºÅ³º¯°æ
	NET_MSG_PET_REQ_SKILLCHANGE_B_BRD	= (NET_MSG_GCTRL + 1150),	// ½ºÅ³º¯°æ
	NET_MSG_PET_ADD_SKILLFACT_B			= (NET_MSG_GCTRL + 1151),	// SkillFact Ãß°¡
	NET_MSG_PET_REMOVE_SKILLFACT_B		= (NET_MSG_GCTRL + 1152),	// SkillFact Ãß°¡

	NET_MSG_PET_GETRIGHTOFITEM_A		= (NET_MSG_GCTRL + 1153),	// ¼ÒÀ¯±ÇÇÑÀÌ ÀÖ´Â ¾ÆÀÌÅÛÁ¤º¸ ¿äÃ»
	NET_MSG_PET_GETRIGHTOFITEM_A_FB		= (NET_MSG_GCTRL + 1154),	// ¼ÒÀ¯±ÇÇÑÀÌ ÀÖ´Â ¾ÆÀÌÅÛÁ¤º¸ ¿äÃ»
	NET_MSG_PET_GETRIGHTOFITEM_B		= (NET_MSG_GCTRL + 1155),	// ¼ÒÀ¯±ÇÇÑÀÌ ÀÖ´Â ¾ÆÀÌÅÛÁ¤º¸ ¿äÃ»
	NET_MSG_PET_GETRIGHTOFITEM_B_FB		= (NET_MSG_GCTRL + 1156),	// ¼ÒÀ¯±ÇÇÑÀÌ ÀÖ´Â ¾ÆÀÌÅÛÁ¤º¸ ¿äÃ»
	...
	NET_MSG_GCTRL_INVEN_UPGRADE_CARD = (NET_MSG_GCTRL + 1063),	//µ¥¯Å¤É¯Å¥d
	NET_MSG_GCTRL_INVEN_UPGRADE_CARD_FB = (NET_MSG_GCTRL + 1064),
	...
	NET_MSG_GCTRL_REMOVE_SKILL_EFFECT_REQ		= (NET_MSG_GCTRL + 1531),	//<	Äù½ºÆ® ¸ÊÀÌµ¿ Á¦ÇÑ.
	NET_MSG_GCTRL_REMOVE_SKILL_EFFECT_BRD		= (NET_MSG_GCTRL + 1532),	//<	Äù½ºÆ® ¸ÊÀÌµ¿ Á¦ÇÑ.
	...
	NET_MSG_GCTRL_PARTY_SEARCH_LURE					= (NET_MSG_GCTRL + 1894),	//<	ÆÄÆ¼ °¡ÀÔ ¿äÃ».			Å¬¶óÀÌ¾ðÆ® -> ¼­¹ö.
	NET_MSG_GCTRL_PARTY_SEARCH_LURE_FB				= (NET_MSG_GCTRL + 1895),	//<	ÆÄÆ¼ °¡ÀÔ ¿äÃ»ÀÇ °á°ú.	Å¬¶óÀÌ¾ðÆ® -> ¼­¹ö.
	NET_MSG_GCTRL_PARTY_SEARCH_LURE_REQUESTOR_FB	= (NET_MSG_GCTRL + 1896),
	NET_MSG_GCTRL_PARTY_SEARCH_LURE_TAR_ANS			= (NET_MSG_GCTRL + 1897),	//<	ÆÄÆ¼ °¡ÀÔ ¿äÃ» ÀÀ´ä.	Å¬¶óÀÌ¾ðÆ® -> ¼­¹ö.
	/*PartySearch - Added By Bubu*/
	NET_MSG_GCTRL_REQ_PARTY_SEARCH_UPDATE			= (NET_MSG_GCTRL + 1898),	//<	Å¬·´µ¥½º¸ÅÄ¡ »óÈ² ¿äÃ»
	...
	NET_MSG_RESET_STATS_REQ							= (NET_MSG_GCTRL + 1905),  //! Á¶ÇÕÀ¸·Î ¼÷·Ãµµ¸¦ ½ÀµæÇÑ ¸ñ·Ï ÀÀ´ä
	NET_MSG_RESET_STATS_FB							= (NET_MSG_GCTRL + 1906),  //! Á¶ÇÕÀ¸·Î ¼÷·Ãµµ¸¦ ½ÀµæÇÑ ¸ñ·Ï ÀÀ´ä
	// LG-7 CWRanking
   ...
   /*get process command, Juver, 2017/06/08 */
	...
	NET_MSG_GCTRL_PVP_CONTROL = (NET_MSG_GCTRL + 3088),
	NET_MSG_GCTRL_SET_POINTS = (NET_MSG_GCTRL + 3089),  //! Á¶ÇÕÀ¸·Î ¼÷·Ãµµ¸¦ ½ÀµæÇÑ ¸ñ·Ï ÀÀ´ä
	NET_MSG_GCTRL_SET_POINTS_FB = (NET_MSG_GCTRL + 3090),  //! Á¶ÇÕÀ¸·Î ¼÷·Ãµµ¸¦ ½ÀµæÇÑ ¸ñ·Ï ÀÀ´ä
	NET_MSG_GCTRL_INVEN_RELL_CHANGE_TO = (NET_MSG_GCTRL + 3091),//Âà¥Í¨t²Î
	NET_MSG_GCTRL_INVEN_RELL_CHANGE_TO_FB = (NET_MSG_GCTRL + 3092),//Âà¥Í¨t²Î
		NET_MSG_GCTRL_INVEN_RESET_SKST_TO = (NET_MSG_GCTRL + 3093),	//¬~ÂI¨t²Î
		NET_MSG_GCTRL_INVEN_RESET_SKST_TO_FB = (NET_MSG_GCTRL + 3094),	//¬~ÂI¨t²Î
		NET_MSG_GCTRL_INVEN_RESET_SKST_TO1 = (NET_MSG_GCTRL + 3095),	//¬~¬õ¨t²Î
		NET_MSG_GCTRL_INVEN_RESET_SKST_TO_FB1 = (NET_MSG_GCTRL + 3096),	//¬~¬õ¨t²Î
		/* Selective Box, Baby011528, 2022-02-15 */
		NET_MSG_GCTRL_INVEN_SELFORM_BOX_OPEN = (NET_MSG_GCTRL + 3097),
		NET_MSG_GCTRL_INVEN_SELFORM_BOX_OPEN_FB = (NET_MSG_GCTRL + 3098),
		/* 3-12-2024Boss Spawn Viewer, Bubu */
		NET_MSG_GCTRL_BOSS_DETAIL_REQ = (NET_MSG_GCTRL + 3099),
		NET_MSG_GCTRL_BOSS_DETAIL_FB = (NET_MSG_GCTRL + 3100),
		/////////////////////////////////////////////////////////////////////////////
		// KILL FEED
		NET_MSG_GCTRL_KILLFEED_SELECT_REQ = (NET_MSG_GCTRL + 3101), // <<< change 3146 to yours
		NET_MSG_GCTRL_KILLFEED_FB = (NET_MSG_GCTRL + 3102), // <<<< change 3147 to yours
		NET_MSG_GCTRL_INVEN_LEARNSKILL_GM = (NET_MSG_GCTRL + 3103),//gm¥þ§Þ¯à
		NET_MSG_GCTRL_INVEN_LEARNSKILL_GM_FB = (NET_MSG_GCTRL + 3104),	//gm¥þ§Þ¯à
		//¸Ë³Æ¤É¯Å
		NET_MSG_ZBSJ_RESULT = (NET_MSG_GCTRL + 3105),	//
		NET_MSG_ZBSJ_RESULT_FB = (NET_MSG_GCTRL + 3106),
		NET_MSG_ZBSJ_MOVE_ITEM = (NET_MSG_GCTRL + 3107),	//

		NET_MSG_GCTRL_INVEN_ZBSJOPEN = (NET_MSG_GCTRL + 3108),	//
		NET_MSG_GCTRL_INVEN_ZBSJOPEN_FB = (NET_MSG_GCTRL + 3109),	//

		NET_MSG_GCTRL_ZBSJOPEN = (NET_MSG_GCTRL + 3110),	//
		NET_MSG_GCTRL_ZBSJOPEN_FB = (NET_MSG_GCTRL + 3111),	//

		NET_MSG_GCTRL_ZBSJHIG_RESULT = (NET_MSG_GCTRL + 3112),	//
		NET_MSG_GCTRL_ZBSJHIG_RESULT_FB = (NET_MSG_GCTRL + 3113),	//

		NET_MSG_ZBSJ_COST_MONEY = (NET_MSG_GCTRL + 3114),	//
		NET_MSG_ZBSJ_INPUT_MONEY = (NET_MSG_GCTRL + 3115),	//

		NET_MSG_GCTRL_REQ_RANKNAME = (NET_MSG_GCTRL + 3116), //MMR Rank
		NET_MSG_GCTRL_REQ_RANKMARK = (NET_MSG_GCTRL + 3117), //MMR Rank
		NET_MSG_GCTRL_REQ_RANKNAME_FB = (NET_MSG_GCTRL + 3118), //MMR Rank
		NET_MSG_GCTRL_REQ_RANKMARK_FB = (NET_MSG_GCTRL + 3119), //MMR Rank
		NET_MSG_GCTRL_REQ_RANKNAME_BRD = (NET_MSG_GCTRL + 3120), //MMR Rank
		NET_MSG_GCTRL_REQ_RANKMARK_BRD = (NET_MSG_GCTRL + 3121), //MMR Rank
		//END
	NET_MSG_GCTRL_MAX											= (NET_MSG_GCTRL + 3900) // °ÔÀÓ¼­¹ö °ÔÀÓÇÃ·¹ÀÌ ÃÖ´ë°ª
};
