...
int COdbcManager::UpdateMoneyPoint( DWORD dwPremium, DWORD dwCombat, CString strUserID )
{
	TCHAR szTemp[128] = {0};
...
int COdbcManager::DeductMoneyPoint( DWORD dwPremium, DWORD dwCombat, CString strUserID )
{
	TCHAR szTemp[128] = {0};
